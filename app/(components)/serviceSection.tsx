          ...
          {servicesData.map((service: Services, index: number) => {
            ...
            return (
              ...
              >
                ...
                <div className="absolute bottom-0 left-8 right-8 h-[1px] bg-pink-500" />
                <div className="absolute left-0 top-8 bottom-8 w-[1px] bg-pink-500" />
                <div className="absolute right-0 top-8 bottom-8 w-[1px] bg-pink-500" />
