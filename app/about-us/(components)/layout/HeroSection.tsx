    ...
    return (
        <section className="container flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-20 mx-auto px-6 py-12 lg:py-24">
            <div className="space-y-4">
                ...
                <h1 className="text-3xl sm:text-4xl lg:text-6xl font-extrabold text-[#1E293B] mb-4 lg:mb-8">Accessible software with a purpose</h1>
                <p className="text-base lg:text-lg/8 font-medium text-gray-500">We bring love and stands for good causes in software development.
                <br/>
